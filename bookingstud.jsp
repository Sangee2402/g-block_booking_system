      ...
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
				 ...
				 System.out.println("000"); 
							...
							String date1=session.getAttribute("from1").toString();
		...
		int count=1;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hallbooking","root","password");
										    ...
										    String query = "select * from bookinghall where from1='"+date1+"' && day1='"+day1+"' && time1='"+time1+"' && floor1='"+floorname+"'"; 
          ...
          <table width="602" height="430" border="0">
            ...
            <tr>
              <td height="56" bgcolor="<%=bg1%>"><div align="center" class="style5"><%=s1%>
                <form id="form1" name="form1" method="post" action="Book01z">
                  <label>
				  <%
				  if(s1.equals("free"))
				  {
              ...
              <td bgcolor="<%=bg2%>"><div align="center"><span class="style5"><%=s2%></span>
                <form id="form2" name="form2" method="post" action="Book02z">
                  <label>
                  <%
              ...
              <td bgcolor="<%=bg3%>"><div align="center"><span class="style5"><%=s3%></span>
                <form id="form3" name="form3" method="post" action="Book03z">
                  <label>
                  <%
				  if(s3.equals("free"))
				  {
            ...
            <tr>
              <td width="204" height="58" bgcolor="<%=bg4%>"><div align="center"><span class="style5"><%=s4%></span>
                <form id="form4" name="form4" method="post" action="Book04z">
                  <label>
                  <%
              ...
              <td width="204" bgcolor="<%=bg5%>"><div align="center"><span class="style5"><%=s5%></span>
                <form id="form5" name="form5" method="post" action="Book05z">
                  <label>
                  <%
				  if(s5.equals("free"))
				  {
              ...
              <td width="183" bgcolor="<%=bg6%>"><label></label>
                <div align="center"><span class="style5"><%=s6%></span>
                    <form id="form6" name="form6" method="post" action="Book06z">
                      <label>
                      <%
				  if(s6.equals("free"))
				  {
            ...
            <tr>
              <td height="55" bgcolor="<%=bg7%>"><div align="center"><span class="style5"><%=s7%></span>
                <form id="form7" name="form7" method="post" action="Book07z">
                  <label>
                  <%
				  if(s7.equals("free"))
				  {
              ...
              <td bgcolor="<%=bg8%>"><div align="center"><span class="style5"><%=s8%></span>
                <form id="form8" name="form8" method="post" action="Book08z">
                  <label>
                  <%
				  if(s8.equals("free"))
				  {
              ...
              <td bgcolor="<%=bg9%>"><label></label>
                <div align="center"><span class="style5"><%=s9%></span>
                    <form id="form9" name="form9" method="post" action="Book09z">
                      <label>
                      <%
				  if(s9.equals("free"))
				  {
