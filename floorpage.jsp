              ...
              <table width="442" height="385" border="0">
                ...
                <tr>
                  <td><div align="center"><span class="style1">
                    <label>
                    <input name="Submit1" type="submit" id="Submit1" value="2nd Floor" />
                    </label>
                  </span></div></td>
                </tr>
                <tr>
                  <td><div align="center">
                    <input type="submit" name="Submit2" value="3rd Floor" />
                  </div></td>
                </tr>
                <tr>
                  <td><div align="center">
                    <input type="submit" name="Submit3" value="4th Floor" />
                  </div></td>
                </tr>
                <tr>
                  <td><div align="center">
                    <input type="submit" name="Submit4" value="5th Floor" />
                  </div></td>
                </tr>
                <tr>
                  <td><div align="center">
