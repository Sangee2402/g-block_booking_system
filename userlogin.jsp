      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="UserLogin">
            <div align="center">
              <table width="389" height="255" border="0">
                <tr>
                  <td height="64" colspan="2" bgcolor="#30B0D5"><div align="center" class="style3">Student  Login </div></td>
                </tr>
                <tr>
                  <td width="212"><span class="style1">Username</span></td>
                  <td width="214"><label>
                ...
                <tr>
                  <td colspan="2"><div align="center">
                      <label>
                      <input type="submit" name="Submit22222" value="Login" />
                      </label>
                  </div></td>
                </tr>
              </table>
